...
//         self.source.to_int() == Self::NullMove.source.to_int() && self.dest.to_int() == Self::NullMove.dest.to_int()
//     }
...
//     #[inline]
//     pub const fn get_source(&self) -> Option<Square> {
//         if self.is_null() {
//             return None;
//         }
//         Some(self.source)
...
//     #[inline]
//     pub const fn get_dest(&self) -> Option<Square> {
//         if self.is_null() {
//             return None;
//         }
//         Some(self.dest)
...
//         let piece = sub_board.piece_type_at(source).ok_or(
//             TimecatError::InvalidSanOrLanMove {
//                 move_: self,
//                 fen: sub_board.get_fen(),
//             },
...
//                 .filter(|m| !(m.get_source().unwrap().to_bitboard() & from_mask).is_empty())
//             {
...
//         match self {
//             &Self::NullMove => todo!(),
//             Self { source, dest, promotion } => match promotion {
//                 Some(piece) => write!(f, "{source}{dest}{piece}"),
//                 None => write!(f, "{source}{dest}"),
//             }
//         }
//     }
// }
