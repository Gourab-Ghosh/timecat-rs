...
// #[cfg_attr(feature = "serde", derive(Serialize, Deserialize))]
// #[derive(PartialEq, Eq, Clone, Copy, Debug, Hash)]
// pub struct Move(Option<LegalMove>);
...
//     #[inline]
//     pub const fn new_unchecked(source: Square, dest: Square, promotion: Option<PieceType>) -> Self {
//         Self(Some(LegalMove::new_unchecked(source, dest, promotion)))
//     }

//     #[inline]
//     pub fn new(source: Square, dest: Square, promotion: Option<PieceType>) -> Result<Self> {
//         Ok(Self(Some(LegalMove::new(source, dest, promotion)?)))
//     }

//     #[inline]
//     pub fn into_inner(&self) -> Option<&LegalMove> {
//         self.0.as_ref()
//     }

//     #[inline]
//     pub fn into_inner_mut(&mut self) -> Option<&mut LegalMove> {
//         self.0.as_mut()
//     }
...
//         self.into_inner().map(|legal_move| legal_move.source)
//     }

//     #[inline]
//     pub fn get_dest(&self) -> Option<Square> {
//         self.into_inner().map(|legal_move| legal_move.dest)
//     }
...
//             for candidate in sub_board.generate_masked_legal_moves(from_mask, to_mask) {
//                 others |= candidate.get_source().unwrap().to_bitboard();
//             }
...
// impl fmt::Display for Move {
//     fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
//         if let Some(legal_move) = self.into_inner() {
//             match legal_move.promotion {
//                 Some(piece) => write!(f, "{}{}{}", legal_move.source, legal_move.dest, piece),
//                 None => write!(f, "{}{}", legal_move.source, legal_move.dest),
//             }
//         } else {
//             write!(f, "--")
//         }
...
//     #[inline]
//     fn from(value: LegalMove) -> Self {
//         Some(value).into()
//     }
// }

// impl From<Option<LegalMove>> for Move {
//     #[inline]
//     fn from(value: Option<LegalMove>) -> Self {
//         Self(value)
//     }
// }
