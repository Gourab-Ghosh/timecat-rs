...
pub mod prelude {
    ...
    pub use super::{
        ...
        King, Knight, MoveGenerator, Pawn, Piece, PieceType, Queen, Rank, RepetitionTable, Rook,
        Square, SubBoard, SubBoardBuilder, TimecatError, TranspositionTable, ValidOrNullMove,
