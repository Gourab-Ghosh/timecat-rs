...
pub mod prelude {
    ...
    pub use super::{
        ...
        Black, Board, BoardStatus, CacheTable, CacheTableSize, CastleMoveType, CastleRights, Color,
        Depth, Engine, Evaluator, File, GameResult, GoCommand, IoReader, King, Knight, BoardPosition,
        BoardPositionBuilder, Move, MoveWeight, Pawn, Piece, PieceType, Ply, Queen, Rank,
