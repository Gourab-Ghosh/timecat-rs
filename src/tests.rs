...
pub fn test(engine: &mut impl ChessEngine) -> Result<()> {
    ...
    // // engine.board.push_san_moves("e4 e5"); // e4 opening
    // // engine.board.push_san_moves("e4 e6 d4 d5"); // caro cann defense
    // // engine.board.push_san_moves("d4 d5 c4"); // queens gambit
    // // engine.board.push_san_moves("d4 d5 c4 dxc4"); // queens gambit accepted
    // // engine.board.push_san_moves("e4 c5"); // sicilian defense
    // // engine.board.push_san_moves("e4 e5 Nf3 Nc6 Bc4 Nf6 Ng5"); // fried liver attack
    // // engine.board.push_san_moves("e4 e5 Nf3 Nc6 Bc4 Nf6 Ng5 Bc5"); // traxler counter attack
    // // engine.board.push_san_moves("e4 e5 Nf3 Nc6 Bc4 Nf6 Ng5 Bc5 Nxf7"); // traxler counter attack with Nxf7
    ...
    // // engine.board.push_san_moves("Qc6+ Kf2 Ra8 Rd1+ Ke8 Rc1 Qe4 Rxc7 Rxa7")?;
    ...
    // // engine.set_fen("8/6K1/4k3/8/8/2Q5/2B5/8 w - - 1 67")?; // Missed mate in 3 (benchmark testcase)
    // // parse_command(engine, "go movetime 3000");
    // parse_command(engine, "go depth 15");

    engine.set_fen("3Q4/1k6/2r5/7r/1R6/P3P3/4KP2/8 b - - 8 68")?;
    parse_command(engine, "go nodes 1488061");
