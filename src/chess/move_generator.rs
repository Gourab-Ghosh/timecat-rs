...
//         self.index = 0;
//         if self.from_bitboard_iterator_mask == mask {
//             return;
//         }
...
//                 .contains(get_item_unchecked!(self.square_and_bitboard_array, i).square)
//         {
//             i += 1;
//         }
...
//             if self
//                 .from_bitboard_iterator_mask
//                 .contains(get_item_unchecked!(self.square_and_bitboard_array, j).square)
//             {
